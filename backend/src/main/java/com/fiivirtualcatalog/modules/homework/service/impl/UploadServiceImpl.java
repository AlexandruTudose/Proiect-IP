...
public class UploadServiceImpl implements UploadService {
    ...
    @Override
    public boolean uploadFile(String courseName,String newFileName, MultipartFile uploadFile) {
        File file = new File("D:\\teme\\" + courseName);
        if (!file.exists()) {
            if (file.mkdir()) {
        ...
        return transferFile(clientsUploadFolder + clientsUploadFolderSep + courseName + clientsUploadFolderSep +  newFileName, uploadFile);
    }
