...
export class HomeworksService {
  ...
  private addHomeworkUrl = "/api/homeworks/upload";
  private getHomeworks = "/api/homeworks";
  ...
  getList() : Observable<JsonObject> {
    return this.http.get(this.getHomeworks)
  ...
  addHomework(postObject) : Observable<any> {
    return this.http.post(this.getHomeworks,JSON.stringify(postObject),  new RequestOptions({headers: this.headers}))
